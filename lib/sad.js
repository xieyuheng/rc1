...
(function() {
  ...
  (function() {
    ...
    eva([1, 2, 3, add, add, sad([1, 2, 3]), add, add, testing_sad, add, add, my_object, "k1", send]);
    asr(argack.pop() === my_object.k1);
    asr(argack.pop() === 6);
    asr(argack.pop() === 6);
    asr(argack.pop() === 6);
    return asr(argack.cursor() === 0);
  })();
